...
class LinkedList {
  ...
  //unshift: adds new node to start of list by correctly setting head and updating length.‣
  ...
  //   getFirst: returns the first node in linked list.
  getFirst() {
    return this.head;
  }
  //   getLast: returns the last node in linked list.
