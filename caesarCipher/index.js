...
/* 
Time Complexity: O(N) because we must visit all characters in input string to encode it.

Space Complexity: O(N) because result string as long as input string.
*/
