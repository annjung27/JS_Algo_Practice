...
function palindrome(str) {
  /*
  Pseudcode
  1. str 이 대문자 소문자 상관없도록 str을 다 lowercase로 만들어줌.
  2. str을 reverse 시킴.
  3. reverse한것과 str을 비교해서 같으면 true, 다르면 false
  */
...
/*
Time Complexity: O(N) because we go over every character in Input String to reverse it. 
 */
